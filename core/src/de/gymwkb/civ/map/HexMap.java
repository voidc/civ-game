...
public class HexMap {
    ...
    public void moveUnit(Hex unit, Hex destination) {
        getCell(destination).setLayer(LayerType.UNIT, getCell(unit).getLayer(LayerType.UNIT));
        getCell(unit).setLayer(LayerType.UNIT, null);
    }
